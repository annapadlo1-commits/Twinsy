# Vintage PRO 2.0.8 — naprawa odpowiedzi panelu
...
3. Zapisz projekt, odśwież arkusz i wybierz **VINTAGE PRO → Przygotuj / napraw wersję 2.0.8**. Ta czynność wiąże wdrożenie z aktualnie otwartym arkuszem.
