# Vintage PRO 2.0.4 — import partiami
...
3. Zapisz projekt, odśwież arkusz i wybierz **VINTAGE PRO → Przygotuj / napraw wersję 2.0.4**. Ta czynność wiąże wdrożenie z aktualnie otwartym arkuszem.
