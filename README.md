# Vintage PRO 2.0.3 — odporny import historyczny
...
3. Zapisz projekt, odśwież arkusz i wybierz **VINTAGE PRO → Przygotuj / napraw wersję 2.0.3**. Ta czynność wiąże wdrożenie z aktualnie otwartym arkuszem.
