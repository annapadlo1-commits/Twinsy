# Vintage PRO 2.0.9 — logowanie kont Gmail
...
3. Zapisz projekt, odśwież arkusz i wybierz **VINTAGE PRO → Przygotuj / napraw wersję 2.0.9**. Ta czynność wiąże wdrożenie z aktualnie otwartym arkuszem.
