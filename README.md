# Vintage PRO 2.0.2 — poprawka importu i panelu
...
3. Zapisz projekt, odśwież arkusz i wybierz **VINTAGE PRO → Przygotuj / napraw wersję 2.0.2**. Ta czynność wiąże wdrożenie z aktualnie otwartym arkuszem.
