...
function onOpen() {
  ...
  SpreadsheetApp.getUi().createMenu('VINTAGE PRO')
    ...
    .addSeparator()
    .addItem('Przygotuj / napraw wersję 2.0.7', 'installFinalVersion')
